...
{
    public abstract class maidCentralTestWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static maidCentralTestWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(maidCentralTestWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<maidCentralTestDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<maidCentralTestDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<maidCentralTestDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<maidCentralTestDbContext, Task<T>> func)
        {
            T result;
