...
namespace maidCentralTest.Migrations
{
    ...
    [Migration("20230820233731_Add-User-to-StartingValues")]
    partial class AddUsertoStartingValues
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("maidCentralTest.StartingValues.StartingValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("maidCentralTest.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("maidCentralTest.Authorization.Users.User", null)
                        .WithMany("Claims")
